/*
 * package com.anchtun.account.config;
 * 
 ...
 * 
 * @Bean public ApplicationRunner runner(AmqpTemplate template) { return args ->
 * template.convertAndSend("zipkin", "zipkin"); }
 * 
 * @Bean public Queue myQueue() { return new Queue("zipkin"); }
 * 
 * @RabbitListener(queues = "zipkin") public void listen(String in) {
